...
import vn.sd.riceshop.model.Order;
import vn.sd.riceshop.model.OrderItem;
import vn.sd.riceshop.model.Product;
import vn.sd.riceshop.service.*;
import vn.sd.riceshop.service.impl.OrderItemService;
import vn.sd.riceshop.service.impl.OrderService;
...
import vn.sd.riceshop.utils.ValidateUtils;
...
public class OrderView {
    ...
    public void addOrder() {
        try {
            ...
            System.out.println("Nhập họ và tên (vd: Dang Minh Sang) ");
            System.out.print(" ⭆ ");
            ...
            while (!ValidateUtils.isNameValid(name)) {
                ...
                System.out.println("Nhập tên (vd: Minh Sang) ");
                System.out.print(" ⭆ ");
            ...
            while (!ValidateUtils.isPhoneValid(phone)) {
                ...
                System.out.println("Nhập số điện thoại (vd: 0398809381)");
                System.out.print(" ⭆ ");
            ...
            do {
                System.out.print("╔═══════════════════════════════════════════════════════════════════════════════════╗\n" +
                        ...
                        "║                            OPTION                                                 ║\n" +
                        "║                                                                                   ║\n" +
                        "║                   [1] Nhấn 'y' để tạo tiếp đơn hàng                               ║\n" +
                        "║                   [2] Nhấn 'q' để trở lại                                         ║\n" +
                        "║                   [3] Nhấn 'p' để in hoá đơn                                      ║\n" +
                        "║                   [4] Nhấn 't' để thoát                                           ║\n" +
                        "║                                                                                   ║\n" +
                        "╚═══════════════════════════════════════════════════════════════════════════════════╝\n");
                System.out.print(" ⭆ ");
