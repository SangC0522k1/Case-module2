...
public class ValidateUtils {
    ...
    public static final String EMAIL_REGEX = "^[a-z0-9._]+@[A-Za-z0-9]+\\.[A-Za-z]{2,3}$";
    public static final String ADDRESS_REGEX = "^[a-zA-Z0-9]+(([',. -][a-zA-Z ])?[a-zA-Z]*)*$";
    ...
    public static boolean isAddressValid(String adress) {
        return Pattern.compile(ADDRESS_REGEX).matcher(adress).matches();
    }
